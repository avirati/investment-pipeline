...
| [0008](./0008-ticket-cached-fetch-layer.md) | Cached fetch layer | One choke point for all network | **Ready** — transport half shipped; cheerio extraction specified (D-8 closed), unwritten |
